...
export function DatasetSequenceRegistry({
  ...
  return (
    <section className="border border-signal-line bg-signal-panel/70 p-3">
      ...
      <div className="mt-3 grid gap-2 lg:grid-cols-5">
        {PERCEPTION_DATASET_SEQUENCES.map((sequence) => (
          <button
            ...
            className={`border p-3 text-left transition ${activeId === sequence.id ? "border-signal-green/60 bg-signal-green/10" : "border-signal-line bg-signal-black/35 hover:border-signal-green/45"}`}
          >
      ...
      <div className="mt-3 flex gap-2 border-l border-signal-green/40 bg-signal-black/35 px-3 py-2 text-xs leading-relaxed text-signal-muted">
