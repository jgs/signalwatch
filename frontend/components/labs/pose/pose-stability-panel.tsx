  ...
  return (
    <div className="space-y-4">
      <div className="grid gap-4 md:grid-cols-[1fr_.9fr]">
        <div className="relative h-72 overflow-hidden border border-[#101b15] bg-[#050806]">
          ...
          {rails.map((rail, index) => (
            <motion.div
              key={rail}
              className="absolute left-1/2 h-1.5 w-1.5 border border-signal-green/40 bg-[#030403]"
