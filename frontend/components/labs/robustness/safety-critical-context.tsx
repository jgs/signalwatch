...
const contexts = [
  ...
  },
  {
    icon: Activity,
    label: "robotics",
    plain: "knowing where objects are",
  ...
  },
  {
    ...
    plain: "working around moving equipment",
  ...
  },
  {
    ...
    plain: "showing uncertainty to people",
  ...
  },
  {
    ...
    plain: "keeping movement stable over time",
  ...
  },
  {
    ...
    plain: "not guessing hidden joints",
...
export function SafetyCriticalContext() {
  return (
    <section className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
      {contexts.map(({ icon: Icon, label, plain, text }) => (
        <div key={label} className="border border-signal-line bg-signal-panel/70 p-4">
          ...
          <div className="mt-2 font-mono text-[0.56rem] uppercase text-signal-dim">plain meaning / {plain}</div>
