      ...
      <section className="relative mx-auto max-w-6xl px-5 py-8 md:px-8 md:py-12">
        ...
        <header className="py-12 md:py-16">
          ...
          <h1 className="mt-9 max-w-4xl text-4xl font-semibold leading-tight text-signal-text md:text-6xl">
            ...
            confidence,
            <br />
            <span className="text-signal-muted">and alignment failure modes.</span>
          </h1>
        ...
        <section className="grid gap-5 lg:grid-cols-[1.15fr_.85fr]">
          <Panel title="real perception under degradation" icon={Camera} meta={cvStatus?.status ?? "browser model"}>
            ...
            <Link
              ...
              className="mt-4 inline-flex border border-signal-line bg-signal-panel2 px-3 py-2 font-mono text-[0.62rem] uppercase text-signal-green/80 transition hover:border-signal-green/60"
            >
        ...
        <section className="mt-5 grid gap-5 lg:grid-cols-[.95fr_1.05fr]">
          <Panel title="alignment failure sandbox" icon={FlaskConical} meta="conceptual simulation">
            <div className="grid gap-5 md:grid-cols-[.9fr_1.1fr]">
              <div className="relative h-64 overflow-hidden border border-signal-line bg-signal-panel">
                ...
                <div className="absolute bottom-5 left-5 right-5 grid grid-cols-2 gap-2 font-mono text-[0.62rem] uppercase text-signal-dim">
                  <div className="border border-signal-line bg-signal-black/80 p-2">intended / safe completion</div>
                  <div className="border border-signal-line bg-signal-black/80 p-2">optimized / proxy shortcut</div>
                </div>
              </div>
              <div className="space-y-4">
                ...
                <div className="border border-signal-line bg-signal-panel/70 p-4 font-mono text-[0.68rem] uppercase text-signal-dim">
        ...
        <section className="mt-5 console-panel p-5">
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-2 xl:grid-cols-3">
            {demos.map((demo) => (
              <div key={demo.id} className="border border-signal-line bg-signal-panel/70 p-4">
